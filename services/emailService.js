    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #666; font-size: 12px; margin-top: 20px;">
          This is an automated message from Mama's Kitchen website contact form.
        </p>
      </div>
    `,
  };
...
const sendContactConfirmation = async (contact) => {
  ...
  const mailOptions = {
    from: config.EMAIL_FROM,
    to: contact.email,
    subject: "Thank you for contacting Mama's Kitchen",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background-color: #DAA520; color: white; padding: 20px; text-align: center;">
          <h1 style="margin: 0;">Mama's Kitchen</h1>
        ...
        <div style="padding: 30px 20px;">
          ...
          <p>Best regards,<br>
          The Mama's Kitchen Team</p>
          
          <hr style="margin: 30px 0; border: none; border-top: 1px solid #eee;">
          
          <div style="text-align: center; color: #666; font-size: 14px;">
            <p><strong>Mama's Kitchen</strong><br>
...
const sendWelcomeEmail = async (email, name) => {
  ...
  const mailOptions = {
    from: config.EMAIL_FROM,
    to: email,
    subject: "Welcome to Mama's Kitchen Family!",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background-color: #DAA520; color: white; padding: 20px; text-align: center;">
          <h1 style="margin: 0;">Welcome to Mama's Kitchen!</h1>
        </div>
        
        <div style="padding: 30px 20px;">
          <h2 style="color: #8B4513;">Thank you for joining us, ${name}!</h2>
          
          <p>We're delighted to have you as part of the Mama's Kitchen family. You'll now receive updates about our latest delicious recipes, special offers, and cooking tips.</p>
